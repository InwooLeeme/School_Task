...
public class Game2p {
    ...
    public void UpdateGame(long gameTime, Point mousePosition) {
        ...
        if (playerRocket.rocket2_Y + playerRocket.rocket2pImgHeight - 10 > landingArea.landingArea2_Y) {
            // Here we check if the rocket is over landing area.
            if ((playerRocket.rocket2_X > landingArea.landingArea2_X)
                    && (playerRocket.rocket2_X < landingArea.landingArea2_X + landingArea.landingArea2ImgWidth
                            - playerRocket.rocket2pImgWidth)) {
                // Here we check if the rocket speed isn't too high.
